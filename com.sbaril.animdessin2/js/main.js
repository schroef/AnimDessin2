    ...
    function init() {
        ...
        $("#btn_minus").click(function (e) {
            if (e.shiftKey)
                ...
                loadJSXFile("/jsx/AnimD2_frameMinusFive.jsx");
            else if (!e.altKey || !e.shiftKey)
        ...
        $("#btn_plus").click(function (e) {
            if (e.shiftKey)
                ...
                loadJSXFile("/jsx/AnimD2_framePlusFive.jsx");
            else if (!e.altKey || !e.shiftKey)
        ...
        $("#btn_red").click(function (e) {
            if (e.altKey && e.shiftKey)
                loadJSXFile("/jsx/AnimD2_colorOnlyClearColor.jsx");
            else if (e.shiftKey)
                loadJSXFile("/jsx/AnimD2_colorGlobalHide.jsx");
            else if (e.altKey)
                loadJSXFile("/jsx/AnimD2_colorGlobalShow.jsx");
            else if (!e.altKey || !e.shiftKey)
        ...
        $("#btn_none").click(function (e) {
            if (e.shiftKey)
                loadJSXFile("/jsx/AnimD2_colorNoneFxHideAll.jsx");
            else if (e.altKey)
                loadJSXFile("/jsx/AnimD2_colorNoneFxShowAll.jsx");
            else if (!e.altKey || !e.shiftKey)
