...
//     };
// }
// var progressBarWindow = progress_bar();


// progressProc(progressCounter, progressTotal)
var progressCounter = 0;
// var progressTotal = docRef.layers.length ;
...
function main() {
    ...
    //     // alert(progressTotal / progressCounter);
    //     // progressCounter = i;
    // }
    // delay(5); // wait a second
    // // progress.value = progress.value + 1; // update the progress bar
    // progress.value = progress.value + count; // update the progress bar
    // delay(1); // wait another second
    // progress.parent.hide(); // close the palette DOESNT WORK!!!!
    // progressBarWindow.hide(); // close the palette
