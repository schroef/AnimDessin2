...
framePlusFive.main = function() {
    applyToAllLayers(framePlusFive);
};

app.activeDocument.suspendHistory(localize(locFramePlusFive), 'framePlusFive.main()');